package com.choebum.portfolio.presentation.controller

import com.choebum.portfolio.domain.constant.SkillType
import com.choebum.portfolio.presentation.service.PresentationService
...
class PresentationViewController(
    ...
    fun getProjects(model: Model): String {
        val project = presentationService.getProjects()
